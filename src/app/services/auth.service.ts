...
export class AuthService {
  ...
  auth0 = new auth0.WebAuth({
    clientID: 'tQIm7qWa408ylksASJmn7NzalxlsdevE',
    domain: 'dev-6bggwtth.eu.auth0.com',
  ...
  public isAuthenticated(): boolean {
    ...
    const storageString = localStorage.getItem('expires_at');
    if(storageString !== null){
        const expiresAt = JSON.parse(storageString);
